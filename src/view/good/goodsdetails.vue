	...
	<div class="goodsdetails" v-if="data">
		<div class="tab_tab">
			<tab :line-width="2" custom-bar-width="60px">
			  	<tab-item selected @on-item-click="onItem_Click">商品</tab-item>
			  	<tab-item @on-item-click="onItem_Click">详情</tab-item>
			  	<tab-item @on-item-click="onItem_Click">评价</tab-item>
			</tab>
		</div>	
		<div>		
			...
			<Offerdetails v-if='Tab_index==1'></Offerdetails>
			<Eva v-if='Tab_index==2'></Eva>	
		</div>
